...
/// \brief <em>The control's "Common" property page</em>
///
/// This class contains the control's "Common" property page.
///
/// \sa SysLink, WindowedLabel, WindowlessLabel, StringProperties
//////////////////////////////////////////////////////////////////////
...
protected:
	...
	struct Controls
	{
		/// \brief <em>Wraps the list view displaying the values for the \c DisabledEvents property</em>
	...
	struct Properties
	{
		...
		/// \brief <em>Holds the number of \c SysLink controls this property page refers to</em>
		int numberOfSysLinks;
		/// \brief <em>Holds the number of \c WindowedLabel controls this property page refers to</em>
		int numberOfWindowedLabels;
		/// \brief <em>Holds the number of \c WindowlessLabel controls this property page refers to</em>
		int numberOfWindowlessLabels;
		...
		Properties()
		{
			...
			numberOfSysLinks = 0;
			numberOfWindowedLabels = 0;
			numberOfWindowlessLabels = 0;
		}
	} properties;
