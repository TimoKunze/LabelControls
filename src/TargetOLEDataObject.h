...
///
/// \if UNICODE
///   \sa LblCtlsLibU::IOLEDataObject, SysLink, WindowedLabel, WindowlessLabel,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \else
///   \sa LblCtlsLibA::IOLEDataObject, WindowedLabel, WindowlessLabel,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \endif
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE TargetOLEDataObject : 
    ...
    #ifdef UNICODE
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_LblCtlsLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #else
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_LblCtlsLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>
    #endif
{
	#ifdef UNICODE
		friend class SysLink;
	#endif
	friend class WindowedLabel;
	friend class WindowlessLabel;
...
public:
	...
	///
	/// \if UNICODE
	///   \sa SetDropDescription, SysLink::get_SupportOLEDragImages, WindowedLabel::get_SupportOLEDragImages,
	///       WindowlessLabel::get_SupportOLEDragImages, LblCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa SetDropDescription, WindowedLabel::get_SupportOLEDragImages,
	///       WindowlessLabel::get_SupportOLEDragImages, LblCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
	...
	///
	/// \if UNICODE
	///   \sa GetDropDescription, SysLink::put_SupportOLEDragImages, WindowedLabel::put_SupportOLEDragImages,
	///       WindowlessLabel::put_SupportOLEDragImages, LblCtlsLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa GetDropDescription, WindowedLabel::put_SupportOLEDragImages,
	///       WindowlessLabel::put_SupportOLEDragImages, LblCtlsLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
